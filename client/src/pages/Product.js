...
const Product = () => {
  ...
  const handleClick = () => {
    if (size === '') {
      return showAlert({
        text:'Пожалуйста, выберите размер обуви',
        icon:'question',
    ...
    <Container>
      ...
      <Wrapper>
        ...
        <InfoContainer>
          ...
          <Desc><span style={{fontWeight: 500}}>Артикул:</span> {product.desc}</Desc>
          ...
          <FilterContainer>
            ...
            <Filter>
              ...
              <FilterSizeOption value='default' disabled >Выбрать</FilterSizeOption>
                {product.size?.map((s) => (
